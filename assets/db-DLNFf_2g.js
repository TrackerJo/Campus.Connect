import{K as Be,N as h,P as d,Q as k,u as st,j as V,U as L,V as v,g as Nt,i as Q,W as D,X as T,Y as S,l as B,Z as q,o as kt,_ as At,S as Ot,T as Fe,$ as N,a0 as $e,a1 as ft,c as z,e as ht,F as oe,d as pt,L as gt,y as Z,q as ne,s as ot,t as Ge,v as x,a2 as se,H as J,J as ae,O as at,I as ce,a as ie,a3 as qt,a4 as Wt,M as Mt,w as re,a5 as $,a6 as He}from"./constants-UfU1BGwP.js";import{_ as le,C as ue,f as mt,h as de,k as H,m as fe,n as he,F as pe,o as je,S as Ve,p as It,g as Y}from"./index-U3pxML4x.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(t,e){return e}class A{constructor(e,o,n,s){this.server=e,this.local=o||e,this.writable=!!n,this.xform=s||zo}}let ut=null;function Jo(t){return!Lt(t)||t.length<2?t:be(t)}function Ue(){if(ut)return ut;const t=[];t.push(new A("bucket")),t.push(new A("generation")),t.push(new A("metageneration")),t.push(new A("name","fullPath",!0));function e(a,c){return Jo(c)}const o=new A("name");o.xform=e,t.push(o);function n(a,c){return c!==void 0?Number(c):c}const s=new A("size");return s.xform=n,t.push(s),t.push(new A("timeCreated")),t.push(new A("updated")),t.push(new A("md5Hash",null,!0)),t.push(new A("cacheControl",null,!0)),t.push(new A("contentDisposition",null,!0)),t.push(new A("contentEncoding",null,!0)),t.push(new A("contentLanguage",null,!0)),t.push(new A("contentType",null,!0)),t.push(new A("metadata","customMetadata",!0)),ut=t,ut}function Ko(t,e){function o(){const n=t.bucket,s=t.fullPath,a=new C(n,s);return e._makeStorageReference(a)}Object.defineProperty(t,"ref",{get:o})}function Qo(t,e,o){const n={};n.type="file";const s=o.length;for(let a=0;a<s;a++){const c=o[a];n[c.local]=c.xform(n,e[c.server])}return Ko(n,t),n}function ke(t,e,o){const n=Se(e);return n===null?null:Qo(t,n,o)}function Yo(t,e,o,n){const s=Se(e);if(s===null||!Lt(s.downloadTokens))return null;const a=s.downloadTokens;if(a.length===0)return null;const c=encodeURIComponent;return a.split(",").map(i=>{const u=t.bucket,f=t.fullPath,p="/b/"+c(u)+"/o/"+c(f),g=wt(p,o,n),m=ve({alt:"media",token:i});return g+m})[0]}function Zo(t,e){const o={},n=e.length;for(let s=0;s<n;s++){const a=e[s];a.writable&&(o[a.server]=t[a.local])}return JSON.stringify(o)}class Ft{constructor(e,o,n,s){this.url=e,this.method=o,this.handler=n,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
