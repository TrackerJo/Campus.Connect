import{d as C,_ as ye,e as ke,f as Ae,h as Ie,C as Ee,k as J,m as Ne,S as xe,F as Oe,n as Ue,r as y,j as l,c as Se,i as ve}from"./index-C75OlIaX.js";import{R as Y,t as Ce,d as P}from"./constants-DuVVuktt.js";import{P as De,Q as Pe}from"./db-DdwSPomz.js";import{R as Le}from"./Resource_Tile-B_m-f0-g.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=k.makeFromUrl(t,n)}catch{return new k(t,"")}if(s.path==="")return s;throw Xe(t)}static makeFromUrl(t,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function o(b){b.path.charAt(b.path.length-1)==="/"&&(b.path_=b.path_.slice(0,-1))}const i="(/(.*))?$",a=new RegExp("^gs://"+r+i,"i"),c={bucket:1,path:3};function h(b){b.path_=decodeURIComponent(b.path)}const u="v[A-Za-z0-9_]+",d=n.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",g=new RegExp(`^https?://${d}/${u}/b/${r}/o${_}`,"i"),w={bucket:1,path:3},m=n===se?"(?:storage.googleapis.com|storage.cloud.google.com)":n,R="([^?#]*)",N=new RegExp(`^https?://${m}/${r}/${R}`,"i"),A=[{regex:a,indices:c,postModify:o},{regex:g,indices:w,postModify:h},{regex:N,indices:{bucket:1,path:2},postModify:h}];for(let b=0;b<A.length;b++){const D=A[b],F=D.regex.exec(t);if(F){const Te=F[D.indices.bucket];let M=F[D.indices.path];M||(M=""),s=new k(Te,M),D.postModify(s);break}}if(s==null)throw We(t);return s}}class Qe{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function et(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function c(){return a===2}let h=!1;function u(...R){h||(h=!0,t.apply(null,R))}function d(R){r=setTimeout(()=>{r=null,e(g,c())},R)}function _(){o&&clearTimeout(o)}function g(R,...N){if(h){_();return}if(R){_(),u.call(null,R,...N);return}if(c()||i){_(),u.call(null,R,...N);return}s<64&&(s*=2);let A;a===1?(a=2,A=0):A=(s+Math.random())*1e3,d(A)}let w=!1;function m(R){w||(w=!0,_(),!h&&(r!==null?(R||(a=2),clearTimeout(r),d(0)):R||(a=1)))}return d(0),o=setTimeout(()=>{i=!0,m(!0)},n),m}function tt(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function dt(...e){const t=ht();if(t!==void 0){const n=new t;for(let s=0;s<e.length;s++)n.append(e[s]);return n.getBlob()}else{if(W())return new Blob(e);throw new p(f.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function ft(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class H{constructor(t,n){this.data=t,this.contentType=n||null}}function _t(e,t){switch(e){case I.RAW:return new H(ae(t));case I.BASE64:case I.BASE64URL:return new H(ce(e,t));case I.DATA_URL:return new H(gt(t),Rt(t))}throw V()}function ae(e){const t=[];for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);if(s<=127)t.push(s);else if(s<=2047)t.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<e.length-1&&(e.charCodeAt(n+1)&64512)===56320))t.push(239,191,189);else{const o=s,i=e.charCodeAt(++n);s=65536|(o&1023)<<10|i&1023,t.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?t.push(239,191,189):t.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(t)}function mt(e){let t;try{t=decodeURIComponent(e)}catch{throw v(I.DATA_URL,"Malformed data URL.")}return ae(t)}function ce(e,t){switch(e){case I.BASE64:{const r=t.indexOf("-")!==-1,o=t.indexOf("_")!==-1;if(r||o)throw v(e,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case I.BASE64URL:{const r=t.indexOf("+")!==-1,o=t.indexOf("/")!==-1;if(r||o)throw v(e,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=pt(t)}catch(r){throw r.message.includes("polyfill")?r:v(e,"Invalid character found")}const s=new Uint8Array(n.length);for(let r=0;r<n.length;r++)s[r]=n.charCodeAt(r);return s}class le{constructor(t){this.base64=!1,this.contentType=null;const n=t.match(/^data:([^,]+)?,/);if(n===null)throw v(I.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=wt(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=t.substring(t.indexOf(",")+1)}}function gt(e){const t=new le(e);return t.base64?ce(I.BASE64,t.rest):mt(t.rest)}function Rt(e){return new le(e).contentType}function wt(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yt(e,t){return t}class T{constructor(t,n,s,r){this.server=t,this.local=n||t,this.writable=!!s,this.xform=r||yt}}let B=null;function kt(e){return!z(e)||e.length<2?e:he(e)}function de(){if(B)return B;const e=[];e.push(new T("bucket")),e.push(new T("generation")),e.push(new T("metageneration")),e.push(new T("name","fullPath",!0));function t(o,i){return kt(i)}const n=new T("name");n.xform=t,e.push(n);function s(o,i){return i!==void 0?Number(i):i}const r=new T("size");return r.xform=s,e.push(r),e.push(new T("timeCreated")),e.push(new T("updated")),e.push(new T("md5Hash",null,!0)),e.push(new T("cacheControl",null,!0)),e.push(new T("contentDisposition",null,!0)),e.push(new T("contentEncoding",null,!0)),e.push(new T("contentLanguage",null,!0)),e.push(new T("contentType",null,!0)),e.push(new T("metadata","customMetadata",!0)),B=e,B}function At(e,t){function n(){const s=e.bucket,r=e.fullPath,o=new k(s,r);return t._makeStorageReference(o)}Object.defineProperty(e,"ref",{get:n})}function It(e,t,n){const s={};s.type="file";const r=n.length;for(let o=0;o<r;o++){const i=n[o];s[i.local]=i.xform(s,t[i.server])}return At(s,e),s}function fe(e,t,n){const s=ue(t);return s===null?null:It(e,s,n)}function Et(e,t,n,s){const r=ue(t);if(r===null||!z(r.downloadTokens))return null;const o=r.downloadTokens;if(o.length===0)return null;const i=encodeURIComponent;return o.split(",").map(h=>{const u=e.bucket,d=e.fullPath,_="/b/"+i(u)+"/o/"+i(d),g=j(_,n,s),w=ie({alt:"media",token:h});return g+w})[0]}function Nt(e,t){const n={},s=t.length;for(let r=0;r<s;r++){const o=t[r];o.writable&&(n[o.server]=e[o.local])}return JSON.stringify(n)}class X{constructor(t,n,s,r){this.url=t,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Re="storage";function zt(e,t,n){return e=C(e),Bt(e,t,n)}function Wt(e){return e=C(e),jt(e)}function Xt(e){return e=C(e),Ft(e)}function we(e,t){return e=C(e),qt(e,t)}function Kt(e=Ae(),t){e=C(e);const s=ye(e,Re).getImmediate({identifier:t}),r=ke("storage");return r&&Gt(s,...r),s}function Gt(e,t,n,s={}){Vt(e,t,n,s)}function Jt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new G(n,s,r,t,xe)}function Yt(){Ie(new Ee(Re,Jt,"PUBLIC").setMultipleInstances(!0)),J(te,ne,""),J(te,ne,"esm2017")}Yt();const be=Kt(Ue);async function Zt(e,t,n,s){console.log("uploading file"),console.log(`${e}/${t}/${n}`);const r=we(be,`${e}/${t}/${n}`),o=await zt(r,s);return await Wt(o.ref)}async function Qt(e,t,n){const s=we(be,`${e}/${t}/${n}`);await Xt(s)}function en({addResource:e,dialogRef:t,close:n,activityId:s}){const[r,o]=y.useState("unset"),[i,a]=y.useState(""),[c,h]=y.useState(""),[u,d]=y.useState(!1),[_,g]=y.useState(""),w=y.useRef(null);return l.jsx("dialog",{ref:t,children:l.jsxs("div",{className:"AddResourceDiv",children:[l.jsx("h2",{children:"Add Resource"}),r=="unset"?l.jsxs("div",{className:"ResourceTypeSelect",children:[l.jsx("h3",{children:"Resource Type"}),l.jsx("button",{className:"ActionBtn",onClick:()=>{o("link")},children:"Link"}),l.jsx("button",{className:"ActionBtn",onClick:()=>{o("image")},children:"Image"}),l.jsx("button",{className:"ActionBtn",onClick:()=>{o("video")},children:"Video"})]}):l.jsxs(l.Fragment,{children:[l.jsx("h3",{children:"Resource Name"}),l.jsx("input",{type:"text",className:"ResourceNameInput",value:i,onChange:m=>{a(m.target.value)}}),l.jsx("h3",{children:"Resource Description"}),l.jsx("input",{type:"text",className:"ResourceDescriptionInput",value:c,onChange:m=>{h(m.target.value)}}),r=="link"?l.jsxs(l.Fragment,{children:[l.jsx("h3",{children:"Link"}),l.jsx("input",{type:"text",className:"ResourceLinkInput",value:_,onChange:m=>{g(m.target.value)}})]}):l.jsxs(l.Fragment,{children:[l.jsx("h3",{children:"Resource File"}),l.jsx("input",{type:"file",className:"ResourceFileInput",ref:w})]}),l.jsx("br",{}),u?l.jsx("div",{className:"loader"}):l.jsx("button",{className:"ActionBtn",onClick:async()=>{if(d(!0),r=="link"){const m=Y.fromBlank(i,c,r,_);await e(m)}else{const m=w.current.files[0];if(m==null)return;const R=m.name.split(".")[0]+Date.now()+"."+m.name.split(".")[1],N=localStorage.getItem("schoolId"),E=await Zt(N,s,R,m),A=Ce.fromBlank(R,E),b=Y.fromBlank(i,c,r,"",A);await e(b)}o("unset"),a(""),h(""),g(""),d(!1)},children:"Add Resource"})]}),l.jsx("br",{}),l.jsx("button",{className:"ActionBtn",onClick:()=>{o("unset"),a(""),h(""),g(""),n()},children:"Close"})]})})}Se(document.getElementById("root")).render(l.jsx(y.StrictMode,{children:l.jsx(tn,{})}));function tn(){const[e,t]=y.useState(""),[n,s]=y.useState(""),[r,o]=y.useState(),[i,a]=y.useState("student"),c=y.useRef(null);y.useEffect(()=>{ve(()=>{});const u=new URLSearchParams(window.location.search),d=u.get("activityId");d&&t(d);const _=u.get("showId");_&&s(_);const g=localStorage.getItem("show-"+_);g&&(o(P.fromMap(JSON.parse(g))),console.log(P.fromMap(JSON.parse(g))));const w=localStorage.getItem("accountType");w&&a(w)},[]);const h=u=>async()=>{if(u.type!="link"){const d=localStorage.getItem("schoolId");await Qt(d,e,u.file.name)}r==null||r.resources.splice(r.resources.indexOf(u),1),localStorage.setItem("show-"+n,JSON.stringify(r)),o(P.fromMap(JSON.parse(localStorage.getItem("show-"+n)))),await Pe(e,n,u)};return l.jsxs(l.Fragment,{children:[l.jsx("div",{className:"title",children:l.jsx("h1",{children:"Resources"})}),l.jsxs("div",{className:"center",children:[l.jsx("div",{className:"resources",children:r==null?void 0:r.resources.map((u,d)=>l.jsx(Le,{resource:u,canRemove:i==="teacher",removeResource:h(u)},d))}),i==="teacher"&&l.jsx("button",{className:"ActionBtn",onClick:()=>{var u;(u=c.current)==null||u.showModal()},children:"Add Resource"}),l.jsx("button",{className:"ActionBtn",onClick:()=>{window.location.href=`/Activity/Shows/Show/?activityId=${e}&showId=${n}`},children:"Back"})]}),l.jsx(en,{dialogRef:c,activityId:e,close:()=>{var u;(u=c.current)==null||u.close()},addResource:async u=>{var d;await De(e,n,u),r==null||r.resources.push(u),localStorage.setItem("show-"+n,JSON.stringify(r)),o(P.fromMap(JSON.parse(localStorage.getItem("show-"+n)))),(d=c.current)==null||d.close()}})]})}
