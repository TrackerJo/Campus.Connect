import{K as Be,N as h,P as d,Q as U,u as nt,j as V,U as L,V as v,g as Ct,i as Q,W as D,X as T,Y as S,l as B,Z as q,o as kt,_ as Ut,S as Nt,T as Fe,$ as N,a0 as $e,a1 as ft,c as z,e as ht,F as oe,d as pt,L as gt,y as Z,q as ne,s as et,t as Ge,v as x,a2 as se,H as J,J as ae,O as st,I as ce,a as ie,a3 as qt,a4 as Wt,M as At,w as re,a5 as $,a6 as He}from"./constants-CQrCYvr3.js";import{_ as le,C as ue,f as mt,h as de,k as H,m as fe,n as he,F as pe,o as je,S as Ve,p as It,g as Y}from"./index-DnJ92IFj.js";/**
 * @license
 ...
 */const qe="type.googleapis.com/google.protobuf.Int64Value",We="type.googleapis.com/google.protobuf.UInt64Value";function ge(t,e){const o={};for(const n in t)t.hasOwnProperty(n)&&(o[n]=e(t[n]));return o}function Mt(t){if(t==null)return null;if(t instanceof Number&&(t=t.valueOf()),typeof t=="number"&&isFinite(t)||t===!0||t===!1||Object.prototype.toString.call(t)==="[object String]")return t;if(t instanceof Date)return t.toISOString();if(Array.isArray(t))return t.map(e=>Mt(e));if(typeof t=="function"||typeof t=="object")return ge(t,e=>Mt(e));throw new Error("Data cannot be encoded in JSON: "+t)}function yt(t){if(t==null)return t;if(t["@type"])switch(t["@type"]){case qe:case We:{const e=Number(t.value);if(isNaN(e))throw new Error("Data cannot be decoded from JSON: "+t);return e}default:throw new Error("Data cannot be decoded from JSON: "+t)}return Array.isArray(t)?t.map(e=>yt(e)):typeof t=="function"||typeof t=="object"?ge(t,e=>yt(e)):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="us-central1";function Ke(t){let e=null;return{promise:new Promise((o,n)=>{e=setTimeout(()=>{n(new K("deadline-exceeded","deadline-exceeded"))},t)}),cancel:()=>{e&&clearTimeout(e)}}}class Qe{constructor(e,o,n,s,a=Rt,c){this.app=e,this.fetchImpl=c,this.emulatorOrigin=null,this.contextProvider=new Je(o,n,s),this.cancelAllRequests=new Promise(r=>{this.deleteService=()=>Promise.resolve(r())});try{const r=new URL(a);this.customDomain=r.origin+(r.pathname==="/"?"":r.pathname),this.region=Rt}catch{this.customDomain=null,this.region=a}}_delete(){return this.deleteService()}_url(e){const o=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${o}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${o}.cloudfunctions.net/${e}`}}function Ye(t,e,o){t.emulatorOrigin=`http://${e}:${o}`}function Ze(t,e,o){return n=>eo(t,e,n,{})}async function to(t,e,o,n){o["Content-Type"]="application/json";let s;try{s=await n(t,{method:"POST",body:JSON.stringify(e),headers:o})}catch{return{status:0,json:null}}let a=null;try{a=await s.json()}catch{}return{status:s.status,json:a}}function eo(t,e,o,n){const s=t._url(e);return oo(t,s,o,n)}async function oo(t,e,o,n){o=Mt(o);const s={data:o},a={},c=await t.contextProvider.getContext(n.limitedUseAppCheckTokens);c.authToken&&(a.Authorization="Bearer "+c.authToken),c.messagingToken&&(a["Firebase-Instance-ID-Token"]=c.messagingToken),c.appCheckToken!==null&&(a["X-Firebase-AppCheck"]=c.appCheckToken);const r=n.timeout||7e4,l=Ke(r),i=await Promise.race([to(e,s,a,t.fetchImpl),l.promise,t.cancelAllRequests]);if(l.cancel(),!i)throw new K("cancelled","Firebase Functions instance was deleted.");const u=ze(i.status,i.json);if(u)throw u;if(!i.json)throw new K("internal","Response is not valid JSON object.");let f=i.json.data;if(typeof f>"u"&&(f=i.json.result),typeof f>"u")throw new K("internal","Response is missing data field.");return{data:yt(f)}}const zt="@firebase/functions",Jt="0.11.8";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(t=he(),e=Rt){const n=de(H(t),Ot).getImmediate({identifier:e}),s=fe("functions");return s&&io(n,...s),n}function io(t,e,o){Ye(H(t),e,o)}function O(t,e,o){return Ze(H(t),e)}co(fetch.bind(self));/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(t){return t!==void 0}function Mo(t){return typeof t=="object"&&!Array.isArray(t)}function xt(t){return typeof t=="string"||t instanceof String}function Kt(t){return Lt()&&t instanceof Blob}function Lt(){return typeof Blob<"u"}function Qt(t,e,o,n){if(n<e)throw Et(`Invalid value for '${t}'. Expected ${e} or greater.`);if(n>o)throw Et(`Invalid value for '${t}'. Expected ${o} or less.`)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(t,e){return e}class A{constructor(e,o,n,s){this.server=e,this.local=o||e,this.writable=!!n,this.xform=s||zo}}let ut=null;function Jo(t){return!xt(t)||t.length<2?t:be(t)}function ke(){if(ut)return ut;const t=[];t.push(new A("bucket")),t.push(new A("generation")),t.push(new A("metageneration")),t.push(new A("name","fullPath",!0));function e(a,c){return Jo(c)}const o=new A("name");o.xform=e,t.push(o);function n(a,c){return c!==void 0?Number(c):c}const s=new A("size");return s.xform=n,t.push(s),t.push(new A("timeCreated")),t.push(new A("updated")),t.push(new A("md5Hash",null,!0)),t.push(new A("cacheControl",null,!0)),t.push(new A("contentDisposition",null,!0)),t.push(new A("contentEncoding",null,!0)),t.push(new A("contentLanguage",null,!0)),t.push(new A("contentType",null,!0)),t.push(new A("metadata","customMetadata",!0)),ut=t,ut}function Ko(t,e){function o(){const n=t.bucket,s=t.fullPath,a=new C(n,s);return e._makeStorageReference(a)}Object.defineProperty(t,"ref",{get:o})}function Qo(t,e,o){const n={};n.type="file";const s=o.length;for(let a=0;a<s;a++){const c=o[a];n[c.local]=c.xform(n,e[c.server])}return Ko(n,t),n}function Ue(t,e,o){const n=Se(e);return n===null?null:Qo(t,n,o)}function Yo(t,e,o,n){const s=Se(e);if(s===null||!xt(s.downloadTokens))return null;const a=s.downloadTokens;if(a.length===0)return null;const c=encodeURIComponent;return a.split(",").map(i=>{const u=t.bucket,f=t.fullPath,p="/b/"+c(u)+"/o/"+c(f),g=wt(p,o,n),m=ve({alt:"media",token:i});return g+m})[0]}function Zo(t,e){const o={},n=e.length;for(let s=0;s<n;s++){const a=e[s];a.writable&&(o[a.server]=t[a.local])}return JSON.stringify(o)}class Bt{constructor(e,o,n,s){this.url=e,this.method=o,this.handler=n,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W{constructor(e,o){this._service=e,o instanceof C?this._location=o:this._location=C.makeFromUrl(o,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,o){return new W(e,o)}get root(){const e=new C(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return be(this._location.path)}get storage(){return this._service}get parent(){const e=Wo(this._location.path);if(e===null)return null;const o=new C(this._location.bucket,e);return new W(this._service,o)}_throwIfRoot(e){if(this._location.path==="")throw So(e)}}function un(t,e,o){t._throwIfRoot("uploadBytes");const n=cn(t.storage,t._location,ke(),new G(e,!0),o);return t.storage.makeRequestWithTokens(n,Ft).then(s=>({metadata:s,ref:t}))}function dn(t){t._throwIfRoot("getDownloadURL");const e=on(t.storage,t._location,ke());return t.storage.makeRequestWithTokens(e,Ft).then(o=>{if(o===null)throw _o();return o})}function fn(t){t._throwIfRoot("deleteObject");const e=nn(t.storage,t._location);return t.storage.makeRequestWithTokens(e,Ft)}function hn(t,e){const o=Xo(t._location.path,e),n=new C(t._location.bucket,o);return new W(t.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
