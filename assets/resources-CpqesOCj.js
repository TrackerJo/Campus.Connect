import{g as C,_ as ye,d as ke,e as Ae,f as xe,C as Ie,h as J,k as Ee,S as Ne,F as Oe,m as Ue,r as y,j as a,c as Se,i as ve}from"./index-DUWJYJoQ.js";import{R as Y,u as Ce,d as P}from"./constants-DQ2WKrIa.js";import{H as De,I as Pe}from"./db-Bth3z0iE.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e,t,n){let s=1,o=null,r=null,i=!1,c=0;function l(){return c===2}let h=!1;function u(...R){h||(h=!0,t.apply(null,R))}function d(R){o=setTimeout(()=>{o=null,e(g,l())},R)}function _(){r&&clearTimeout(r)}function g(R,...E){if(h){_();return}if(R){_(),u.call(null,R,...E);return}if(l()||i){_(),u.call(null,R,...E);return}s<64&&(s*=2);let A;c===1?(c=2,A=0):A=(s+Math.random())*1e3,d(A)}let w=!1;function m(R){w||(w=!0,_(),!h&&(o!==null?(R||(c=2),clearTimeout(o),d(0)):R||(c=1)))}return d(0),r=setTimeout(()=>{i=!0,m(!0)},n),m}function et(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
